...
//
//     final rechargeRequestModel = rechargeRequestModelFromJson(jsonString);

import 'dart:convert';

RechargeRequestModel rechargeRequestModelFromJson(String str) =>
    RechargeRequestModel.fromJson(json.decode(str));

String rechargeRequestModelToJson(RechargeRequestModel data) =>
